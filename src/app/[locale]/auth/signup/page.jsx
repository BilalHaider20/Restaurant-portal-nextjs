  ...
  return (
    <div className="flex flex-col items-center justify-center w-6/12 h-full py-20 bg-background-blue">
      <div className="container  mx-auto w-9/12 text-center">
        <h1 className="text-3xl font-semibold text-heading-grey tracking-tighter ">
          Welcome to Bookme
        </h1>
        <span className="text-lg text-heading-grey tracking-tighter font-light">
          Please provide details below to login your account
        </span>
      </div>
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="my-10 container mx-auto w-9/12 space-y-4"
      >
        ...
        <button
          type="submit"
          className="bg-light-blue text-white py-2 px-4 rounded w-full"
        >
          Sign In
        </button>
      </form>
      ...
      <div className="flex flex-col w-9/12 mt-7 space-y-2">
        <a className="btnSigninWith" href="">
          <Image src="/assets/images/google.png" width={15} height={15}></Image>{" "}
          Sign in with Google
        </a>
        <a className="btnSigninWith" href="">
          <Image
      ...
      <p className="flex font-base items-center gap-2 mt-7 ">
        Already have an account?{" "}
        <Link
          className="font-base text-light-blue text-semibold"
          href="/en/auth/login"
        >
          Sign In
        </Link>
      ...
      <p className="flex font-base items-center gap-2 mt-7 ">
        ...
        <Link className="font-base text-light-blue " href="">
          Terms Conditions
        </Link>{" "}
        &{" "}
        <Link className="font-base text-light-blue " href="">
